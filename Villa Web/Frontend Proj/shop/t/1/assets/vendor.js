...
! function(e, t) {
    ...
    function p(e, t, n, i, o) {
        for (var r, s, a, l, u, p, f = t.createDocumentFragment(), h = [], v = 0, g = e.length; g > v; v++)
            if (r = e[v], r || 0 === r)
                if ("object" === re.type(r)) re.merge(h, r.nodeType ? [r] : r);
                else if (_e.test(r)) {
            for (s = s || f.appendChild(t.createElement("div")), a = (Pe.exec(r) || ["", ""])[1].toLowerCase(), l = qe[a] || qe._default, s.innerHTML = l[1] + re.htmlPrefilter(r) + l[2], p = l[0]; p--;) s = s.lastChild;
            re.merge(h, s.childNodes), s = f.firstChild, s.textContent = ""
        } else h.push(t.createTextNode(r));
        for (f.textContent = "", v = 0; r = h[v++];)
            if (i && re.inArray(r, i) > -1) o && o.push(r);
            else if (u = re.contains(r.ownerDocument, r), s = c(f.appendChild(r), "script"), u && d(s), n)
    ...
    function k(e, t, n, i) {
        ...
        if (f && (o = p(t, e[0].ownerDocument, !1, e, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            ...
            if (a)
                for (u = s[s.length - 1].ownerDocument, re.map(s, w), d = 0; a > d; d++) l = s[d], Le.test(l.type || "") && !Ce.access(l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent.replace(Ue, "")))
        }
        return e
    }
    ...
    function D(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += re.css(e, n + Ne[r], !0, o)), i ? ("content" === n && (s -= re.css(e, "padding" + Ne[r], !0, o)), "margin" !== n && (s -= re.css(e, "border" + Ne[r] + "Width", !0, o))) : (s += re.css(e, "padding" + Ne[r], !0, o), "padding" !== n && (s += re.css(e, "border" + Ne[r] + "Width", !0, o)));
        return s
    }
    ...
    function N(t, n, i) {
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (r = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= r || null == r) {
            if (r = E(t, n, s), (0 > r || null == r) && (r = t.style[n]), Ge.test(r)) return r;
    ...
    function L(e, t) {
        ...
        for (t = t ? 1 : 0; 4 > i; i += 2 - t) n = Ne[i], o["margin" + n] = o["padding" + n] = e;
        return t && (o.opacity = o.width = e), o
    }

    function q(e, t, n) {
        for (var i, o = (I.tweeners[t] || []).concat(I.tweeners["*"]), r = 0, s = o.length; s > r; r++)
    ...
    function _(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = re.css(e, "display"), c = "none" === u ? Ce.get(e, "olddisplay") || C(e.nodeName) : u, "inline" === c && "none" === re.css(e, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", d.always(function() {
        ...
        if (re.isEmptyObject(p)) "inline" === ("none" === u ? C(e.nodeName) : u) && (f.display = u);
        else {
            v ? "hidden" in v && (h = v.hidden) : v = Ce.access(e, "fxshow", {}), r && (v.hidden = !h), h ? re(e).show() : d.done(function() {
                re(e).hide()
            }), d.done(function() {
                var t;
                Ce.remove(e, "fxshow");
            ...
            for (i in p) s = q(h ? v[i] : 0, i, d), i in v || (v[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function I(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = ot || P(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, r = 1 - i, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(r);
        ...
        for (z(c, u.opts.specialEasing); s > r; r++)
            if (i = I.prefilters[r].call(u, e, c, u.opts)) return re.isFunction(i.stop) && (re._queueHooks(u.elem, u.opts.queue).stop = re.proxy(i.stop, i)), i;
    ...
    var ce = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : F) !== O && N(t), t = t || O, P)) {
                if (11 !== v && (u = me.exec(e)))
                    if (o = u[1]) {
                        if (9 === v) {
                ...
                if (x.qsa && !U[e + " "] && (!L || !L.test(e))) {
                    if (1 !== v) h = t, f = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(we, "\\$&") : t.setAttribute("id", a = I), d = C(e), r = d.length, l = pe.test(a) ? "#" + a : "[id='" + a + "']"; r--;) d[r] = l + " " + p(d[r]);
        ...
        function m(e, t, n, o, r, s) {
            return o && !o[I] && (o = m(o)), r && !r[I] && (r = m(r, s)), i(function(i, s, a, l) {
                var u, c, d, p = [],
                    ...
                    w = n ? r || (i ? e : h || o) ? [] : s : y;
                if (n && n(y, w, a, l), o)
                    for (u = g(w, f), o(u, [], a, l), c = u.length; c--;)(d = u[c]) && (w[f[c]] = !(y[f[c]] = d));
                if (i) {
                    if (r || e) {
                        if (r) {
            ...
            var o = n.length > 0,
                ...
                s = function(i, s, a, l, u) {
                    ...
                    for (u && (A = s === O || s || u); h !== x && null != (c = w[h]); h++) {
                        if (r && c) {
                            for (d = 0, s || c.ownerDocument === O || (N(c), a = !P); p = e[d++];)
                                if (p(c, s || O, a)) {
                                    l.push(c);
                                    break
                                }
        ...
        var b, x, k, T, S, C, E, $, A, j, D, N, O, H, P, L, q, _, z, I = "sizzle" + 1 * new Date,
            F = e.document,
            M = 0,
            R = 0,
            W = n(),
        ...
        x = t.support = {}, S = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, H = O.documentElement, P = !S(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), x.attributes = o(function(e) {
            ...
            }, q = [], L = [], (x.qsa = ge.test(O.querySelectorAll)) && (o(function(e) {
                ...
                x.disconnectedMatch = _.call(e, "div"), _.call(e, "[s!='']:x"), q.push("!=", re)
            }), L = L.length && new RegExp(L.join("|")), q = q.length && new RegExp(q.join("|")), t = ge.test(H.compareDocumentPosition), z = t || ge.test(H.contains) ? function(e, t) {
            ...
            if ((e.ownerDocument || e) !== O && N(e), n = n.replace(ce, "='$1']"), x.matchesSelector && P && !U[n + " "] && (!q || !q.test(n)) && (!L || !L.test(n))) try {
                var i = _.call(e, n);
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        var u, c, d, p, f, h, v = r !== s ? "nextSibling" : "previousSibling",
                            g = t.parentNode,
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                for (p = g, d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], w = f && u[2], p = f && g.childNodes[f]; p = ++f && p && p[v] || (w = f = 0) || h.pop();)
                                    if (1 === p.nodeType && ++w && p === t) {
                                        c[e] = [M, f, w];
                                        break
                                    }
                            } else if (y && (p = t, d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], w = f), w === !1)
                                for (;
                                    (p = ++f && p && p[v] || (w = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++w || (y && (d = p[I] || (p[I] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), c[e] = [M, w]), p !== t)););
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, C = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === d.length) {
                if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === t.nodeType && P && k.relative[r[1].type]) {
                ...
                for (o = fe.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !k.relative[a = s.type]);)
                    if ((l = k.find[a]) && (i = l(s.matches[0].replace(be, xe), ye.test(r[0].type) && c(t.parentNode) || t))) {
                        if (r.splice(o, 1), e = i.length && p(r), !e) return Z.apply(n, i), n;
                        break
                    }
            }
            return (u || E(e, d))(i, t, !P, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, x.sortStable = I.split("").sort(X).join("") === I, x.detectDuplicates = !!D, N(), x.sortDetached = o(function(e) {
    ...
    re.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), i = new Array(s); s > o; o++) r[o] && re.isFunction(r[o].promise) ? r[o].promise().progress(u(o, n, t)).done(u(o, i, r)).fail(l.reject) : --a;
    ...
    re.extend({
        ...
        data: function(e, t) {
            var n, i, o, r = this[0],
                s = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (o = Ee.get(r), 1 === r.nodeType && !Ce.get(r, "hasDataAttrs"))) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, i;
                if (r && void 0 === t) {
                    if (n = Ee.get(r, e) || Ee.get(r, e.replace(Ae, "-$&").toLowerCase()), void 0 !== n) return n;
                    if (i = re.camelCase(e), n = Ee.get(r, i), void 0 !== n) return n;
    ...
    re.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, u, c, d, p, f, h, v, g = Ce.get(e);
            if (g)
        ...
        remove: function(e, t, n, i, o) {
            var r, s, a, l, u, c, d, p, f, h, v, g = Ce.hasData(e) && Ce.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match(xe) || [""], u = t.length; u--;)
                    if (a = Fe.exec(t[u]) || [], f = v = a[1], h = (a[2] || "").split(".").sort(), f) {
    ...
    re.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
                for (s = c(a), r = c(e), i = 0, o = r.length; o > i; i++) x(r[i], s[i]);
            if (t)
                if (n)
        ...
        html: function(e) {
            return Te(this, function(e) {
                ...
                if ("string" == typeof e && !Re.test(e) && !qe[(Pe.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    re.extend({
        ...
        css: function(e, t, n, i) {
            var o, r, s, a = re.camelCase(t);
            return t = re.cssProps[a] || (re.cssProps[a] = A(a) || a), s = re.cssHooks[t] || re.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = E(e, t, i)), "normal" === o && t in tt && (o = tt[t]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
        }
    ...
    re.extend(re.event, {
        trigger: function(t, n, i, o) {
            ...
            if (s = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !vt.test(f + re.event.triggered) && (f.indexOf(".") > -1 && (h = f.split("."), f = h.shift(), h.sort()), u = f.indexOf(":") < 0 && "on" + f, t = t[re.expando] ? t : new re.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), d = re.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                ...
                for (r = 0;
                    (s = p[r++]) && !t.isPropagationStopped();) t.type = r > 1 ? l : d.bindType || f, c = (Ce.get(s, "events") || {})[t.type] && Ce.get(s, "handle"), c && c.apply(s, n), c = u && s[u], c && c.apply && Se(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = f, o || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !Se(i) || u && re.isFunction(i[f]) && !re.isWindow(i) && (a = i[u], a && (i[u] = null), re.event.triggered = f, i[f](), re.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    At.href = gt.href, re.extend({
        ...
        ajax: function(t, n) {
            ...
            if (v.promise(k).complete = g.add, k.success = k.done, k.error = k.fail, p.url = ((t || p.url || gt.href) + "").replace(wt, "").replace(St, gt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = re.trim(p.dataType || "*").toLowerCase().match(xe) || [""], null == p.crossDomain) {
                u = G.createElement("a");
                try {
    ...
    ie.cors = !!Lt && "withCredentials" in Lt, ie.ajax = Lt = !!Lt, re.ajaxTransport(function(t) {
        ...
        return ie.cors || Lt && !t.crossDomain ? {
            send: function(o, r) {
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Pt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    re.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(_t, "$1" + o) : t.jsonp !== !1 && (t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            ...
            void 0 === r ? re(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, qt.push(o)), s && re.isFunction(r) && r(s[0]), s = r = void 0
        }), "script") : void 0
    ...
    re.fn.load = function(e, t, n) {
        ...
        re.cssHooks[t] = $(ie.pixelPosition, function(e, n) {
            return n ? (n = E(e, t), Ge.test(n) ? re(e).position()[t] + "px" : n) : void 0
        })
    }), re.each({
        Height: "height",
        Width: "width"
...
function(e) {
    ...
    e.zoom = function(t, n, i, o) {
        ...
        return t.style.position = /(absolute|fixed)/.test(f) ? f : "relative", t.style.overflow = "hidden", i.style.width = i.style.height = "", e(i).addClass("zoomImg").css({
            ...
            init: function() {
                s = p.outerWidth(), r = p.outerHeight(), n === t ? (l = s, a = r) : (l = h.outerWidth(), a = h.outerHeight()), u = (i.width - s) / l, c = (i.height - r) / a, d = h.offset()
            },
            move: function(e) {
        ...
        return this.each(function() {
            ...
            s.one("zoom.destroy", function(e, t) {
                ...
                "grab" === i.on ? s.on("mousedown.zoom", function(i) {
                    ...
                    }), t(i), e(document).on(u, p.move), i.preventDefault())
                }) : "click" === i.on ? s.on("click.zoom", function(i) {
                    return c ? void 0 : (c = !0, t(i), e(document).on(u, p.move), e(document).one("click.zoom", function() {
                        n(), c = !1, e(document).off(u, p.move)
                    }), !1)
                }) : "toggle" === i.on ? s.on("click.zoom", function(e) {
                    c ? n() : t(e), c = !c
                }) : "mouseover" === i.on && (p.init(), s.on("mouseenter.zoom", t).on("mouseleave.zoom", n).on(u, p.move)), i.touch && s.on("touchstart.zoom", function(e) {
...
function() {
    ...
    function d(e, t, n, i) {
        var o;
        return (o = e === le) || (o = Te[n], o = (e === o || e !== e && o !== o) && !Se.call(i, n)), o ? t : e
    }
    ...
    function b(e, t, n, i, o, r) {
        var s = Re(e),
            ...
            u = "[object Array]",
            c = "[object Array]";
        s || (u = Ee.call(e), "[object Arguments]" == u && (u = "[object Object]")), l || (c = Ee.call(t), "[object Arguments]" == c && (c = "[object Object]"));
        var d = "[object Object]" == u && !a(e),
            l = "[object Object]" == c && !a(t);
        return !(c = u == c) || s || d ? 2 & o || (u = d && Se.call(e, "__wrapped__"), l = l && Se.call(t, "__wrapped__"), !u && !l) ? !!c && (r || (r = []), (u = M(r, function(t) {
            return t[0] === e
        })) && u[1] ? u[1] == t : (r.push([e, t]), t = (s ? L : _)(e, t, n, i, o, r), r.pop(), t)) : n(u ? e.value() : e, l ? t.value() : t, i, o, r) : q(e, t, u)
    }
    ...
    function N(e, t, n, i) {
        ...
        for (var o = -1, r = t.length; ++o < r;) {
            var s = t[o],
                ...
                l = n,
                u = l[s];
            Se.call(l, s) && (u === a || u !== u && a !== a) && (a !== le || s in l) || (l[s] = a)
        }
        return n
    }
    ...
    function U(e) {
        var t;
        if ("function" != typeof e) throw new TypeError("Expected a function");
        return t = Pe(t === le ? e.length - 1 : We(t), 0),
            function() {
                for (var n = arguments, i = -1, o = Pe(n.length - t, 0), r = Array(o); ++i < o;) r[i] = n[t + i];
    ...
    function Y(e) {
        return Z(e) && V(e) && Se.call(e, "callee") && (!Ne.call(e, "callee") || "[object Arguments]" == Ee.call(e))
    }
    ...
    function ie(e) {
        ...
        var n, i = z(e),
            ...
            i = i || [],
            r = i.length;
        for (n in e) !Se.call(e, n) || o && ("length" == n || l(n, r)) || t && "constructor" == n || i.push(n);
        return i
    }
    ...
    function oe(e) {
        for (var t = -1, n = I(e), i = k(e), o = i.length, r = z(e), s = !!r, r = r || [], a = r.length; ++t < o;) {
            var u = i[t];
            s && ("length" == u || l(u, a)) || "constructor" == u && (n || !Se.call(e, u)) || r.push(u)
        }
        return r
    }
    ...
    c.prototype = p(u.prototype), c.prototype.constructor = c, u.assignIn = Xe, u.before = B, u.bind = Ie, u.chain = function(e) {
        ...
        var i = e ? e.length : 0;
        n = "number" == typeof n ? 0 > n ? Pe(i + n, 0) : n : 0, n = (n || 0) - 1;
        for (var o = t === t; ++n < i;) {
            var r = e[n];
        ...
        chain: !1
    }), u.VERSION = "4.5.1", Le("pop join replace reverse split push shift sort splice unshift".split(" "), function(e) {
    ...
    ! function(e, t, n) {
        ...
        function g(e, t, n, o, r) {
            ...
            return i(t, "string") || i(t, "undefined") ? v(a, t, o, r) : (a = (e + " " + E.join(s + " ") + s).split(" "), c(a, t, n))
        }
        ...
        e.disableBodyScroll = function(e, i) {
            if (o) {
                ...
                if (e && !r.some(function(t) {
                    ...
                    r = [].concat(t(r), [p]), e.ontouchstart = function(e) {
                        1 === e.targetTouches.length && (a = e.targetTouches[0].clientY)
                    }, e.ontouchmove = function(t) {
                        var n, i, o, r;
                        1 === t.targetTouches.length && (i = e, r = (n = t).targetTouches[0].clientY - a, !c(n.target) && (i && 0 === i.scrollTop && 0 < r ? d(n) : (o = i) && o.scrollHeight - o.scrollTop <= o.clientHeight && r < 0 ? d(n) : n.stopPropagation()))
